...
public class Order extends BaseEntity {
    ...
    private LocalDateTime payDate; // 결제여부
    private LocalDateTime cancelDate; // 취소여부
    private LocalDateTime refundDate; // 환불여부
    ...
    public long calcPayPrice() {
        return orderItems.stream().mapToInt(OrderItem::getPayPrice).sum();
    }

...
public class NotProd {
    ...
    public void work1() {
        ...
        Book book3 = bookService.createBook(memberUser2, "책 제목 3", "책 내용 3", 10_000);
        Book book4 = bookService.createBook(memberUser3, "책 제목 4", "책 내용 4", 10_000);
        Book book5 = bookService.createBook(memberUser3, "책 제목 5", "책 내용 5", 10_000);
        Book book6 = bookService.createBook(memberUser3, "책 제목 6", "책 내용 6", 10_000);
